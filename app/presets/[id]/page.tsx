  ...
  return (
    <div className="min-h-screen bg-slate-50 p-8">
      ...
      <nav className="flex items-center gap-2 text-sm text-slate-500 mb-4">
        ...
        <span className="text-slate-900 font-medium">{preset.name}</span>
      </nav>
      ...
      {icons.length === 0 ? (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
          {icons.map(icon => (
            ...
            >
              <div 
                className="aspect-square bg-slate-50 rounded-xl flex items-center justify-center mb-4 border border-slate-100"
